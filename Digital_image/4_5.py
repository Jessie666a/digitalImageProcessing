...
BLPFimg = myDFTandBLPF(grayImg, 50, 2)

# 循环显示
imgList = [grayImg, BLPFimg[0], BLPFimg[4][:, :, 0]]
...
ax.plot_surface(u, v, BLPFimg[4][:, :, 0], cmap='viridis')
plt.axis('off')
